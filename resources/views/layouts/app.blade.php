                        ...
                        @else
                            <li class="nav-item dropdown">
                                ...
                                <div class="dropdown-menu dropdown-menu-end" aria-labelledby="navbarDropdown">
                                    ...
                                    <form id="posts-form" action="{{ route('posts') }}" method="GET" class="d-none">
                                        @csrf
                                    </form>
                                    <form id="tags-form" action="{{ route('tags') }}" method="GET" class="d-none">
                                        @csrf
                                    </form>
                                    <form id="users-form" action="{{ route('users') }}" method="GET" class="d-none">
                                        @csrf
                                    </form>
